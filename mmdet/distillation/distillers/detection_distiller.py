...
from mmengine.runner.checkpoint import load_state_dict, _load_checkpoint, load_checkpoint
...
class DetectionDistiller(BaseDetector):
    ...
    def __init__(self,
        ...
        self.teacher = RUNNERS.build(teacher_cfg.model)
        self.init_weights_teacher(teacher_pretrained)
        self.teacher.eval()

        self.student= RUNNERS.build(student_cfg.model)
        if init_student:
